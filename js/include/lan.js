...
function init_lan() {
	...
	alla_lan.push(new lan("Gotlands län", 09, 57391));
	...
	alla_lan.push(new lan("Jönköpings län", 06, 347837));
	alla_lan.push(new lan("Kalmar län", 08, 237679));
	alla_lan.push(new lan("Kronobergs län", 07, 191369));
	alla_lan.push(new lan("Norrbottens län", 25, 249733));
	alla_lan.push(new lan("Skåne län", 12, 1303627));
	alla_lan.push(new lan("Stockholms län", 01, 2231439));
	alla_lan.push(new lan("Södermanlands län", 04, 283712));
	alla_lan.push(new lan("Uppsala län", 03, 354164));
	...
	alla_lan.push(new lan("Östergötlands län", 05, 445661));
}
